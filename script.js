...
async function main() {
  ...
  if (isBlueVerified) {
    ...
    for (const node of nodes) {
      node.parentElement.parentElement.parentElement.innerHTML = `<div style='display: flex; flex-direction: row; align-items: center; border-radius: 120px; border: 1px solid #536471; padding: 0.1rem 0.4rem 0.1rem 0.2rem; gap: 0.2rem;'><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
